              ...
              builder: (context, snapshot) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final atendimentoMood = data['atendimentoMood'] as String? ?? '';
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (atendimentoMood.isNotEmpty) ...[
                          _buildTag(atendimentoMood.toUpperCase(), isDark ? const Color(0xFF304FFE) : const Color(0xFFE8F0FE), isDark ? Colors.white : const Color(0xFF304FFE)),
                          const SizedBox(width: 8),
                        ],
                        if (tags.isNotEmpty) ...[
                          _buildTag(tags.first.toUpperCase(), isDark ? const Color(0xFF424242) : const Color(0xFFEAF2F8), isDark ? Colors.white : const Color(0xFF2C3E50)),
                          const SizedBox(width: 8),
                        ],
                        const SizedBox(height: 12),
                        Row(
                          children: [
                            _buildTag(type, isDark ? primaryColor.withAlpha((0.2 * 255).round()) : const Color(0xFFF2D7D5), isDark ? Colors.white : primaryColor),
                            const SizedBox(width: 8),
