...
class _ChamadosPageState extends State<ChamadosPage> {
  ...
  void _openChamadoDetail(BuildContext context, ChamadoModel chamado) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => ChamadoDetailPage(chamado: chamado),
      ),
    );
  }
          ...
          Padding(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                border: Border.all(color: primaryColor.withAlpha((0.1 * 255).round())),
              ),
              child: TextField(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: isDark ? primaryColor.withAlpha((0.2 * 255).round()) : const Color(0xFFF2D7D5),
                                          ...
                                          children: [
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                  padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                                                  decoration: BoxDecoration(
                                                    color: isDark ? primaryColor.withAlpha((0.15 * 255).round()) : const Color(0xFFF2D7D5),
                                                    borderRadius: BorderRadius.circular(2),
                                                  ),
                                                  child: Text(
                                                    statusText,
                                            ...
                                            SizedBox(
                                              ...
                                              child: ElevatedButton(
                                                onPressed: () => _openChamadoDetail(context, chamado),
