...
class _FeedbackPageState extends State<FeedbackPage> {
  ...
  void _selectMood(int mood) {
    setState(() {
      _selectedMood = mood;
      if (mood == 0) {
        _moodController.text = 'O atendimento foi ruim e precisa melhorar.';
      } else if (mood == 1) {
        _moodController.text = 'O atendimento foi bom, mas ainda pode evoluir.';
      } else {
        _moodController.text = 'O atendimento foi ótimo e superou minhas expectativas.';
      }
    });
  }
    ...
    try {
      ...
      if (!await file.exists()) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Não foi possível acessar a imagem capturada. Tente novamente.')),
        );
        return;
      }
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildHeader(
                        _currentStep == 1 ? 'Etapa 1: Início do lote' : 'Etapa 2: Atendimento e logística',
                        _currentStep == 1
                            ? 'Insira o código e faça sua avaliação da Copperfio.'
                            : _selectedMood != null && _moodController.text.trim().isNotEmpty
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(color: textColor.withAlpha((0.75 * 255).round())),
                          ),
                          const SizedBox(height: 24),
                          SizedBox(
                            height: 52,
