...
class PerfilGestorPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final profileFuture = AuthService().getCurrentUserData();
        ...
        child: Column(
          children: [
            ...
            FutureBuilder<Map<String, dynamic>?>(
              ...
              builder: (context, snapshot) {
                final data = snapshot.data ?? {};
                final empresa = data['empresa'] ?? data['empresaId'] ?? 'Copperfio';
                final cnpj = data['cnpj'] ?? 'Não informado';
                final cargo = data['cargo'] ?? 'Gestor Operacional';
                final setor = data['setor'] ?? data['departamento'] ?? 'Produção';
                final matricula = data['matricula'] ?? data['idInterno'] ?? 'G-204';
                final email = data['email'] ?? 'Não informado';
                final telefone = data['telefone'] ?? data['celular'] ?? 'Não informado';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            _buildInfoRow(Icons.business, 'Empresa', empresa),
                            _buildInfoDivider(context),
                            _buildInfoRow(Icons.badge, 'Cargo', cargo),
                            _buildInfoDivider(context),
                            _buildInfoRow(Icons.location_city, 'Setor', setor),
                            _buildInfoDivider(context),
                            _buildInfoRow(Icons.confirmation_number, 'Matrícula', matricula),
                            _buildInfoDivider(context),
                            _buildInfoRow(Icons.email, 'Email corporativo', email),
                            _buildInfoDivider(context),
                            _buildInfoRow(Icons.phone, 'Telefone corporativo', telefone),
                            _buildInfoDivider(context),
                            _buildInfoRow(Icons.corporate_fare, 'CNPJ', cnpj),
                          ],
                        ),
                      ),
                    ],
