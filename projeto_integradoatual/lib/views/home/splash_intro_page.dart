...
import 'package:projeto_integrado/views/home/acess_page.dart';
...
class _SplashIntroPageState extends State<SplashIntroPage> {
  ...
  void _goToAccessPage() {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (_) => const AcessPage()),
    );
  }
  ...
  void initState() {
    super.initState();
    Future.delayed(const Duration(seconds: 4), _goToAccessPage);
  }
